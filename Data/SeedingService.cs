...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Bob Marley", "marley@mail.com", new DateTime(1998, 4, 21), 1000.0, d1);
            Seller s2 = new Seller(2, "Cristiano Ronaldo", "cr7@mail.com", new DateTime(1998, 4, 21), 1000.0, d3);
            Seller s3 = new Seller(3, "Ana Maria Braga", "ana@mail.com", new DateTime(1998, 4, 21), 1000.0, d4);
            Seller s4 = new Seller(4, "Robert D Jr", "iron@mail.com", new DateTime(1998, 4, 21), 1000.0, d2);
            Seller s5 = new Seller(5, "Robisvaldo Neto", "Robisvaldo@mail.com", new DateTime(1998, 4, 21), 1000.0, d2);
